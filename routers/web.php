...
$router->add('posts/{id:\d+}/delete', ['controller' => \App\controller\admin\PostsController::class, 'action'=> 'destroy', 'method'=> 'POST']);
...
$router->add('category/{id:\d+}', ['controller' => \App\controller\categories\CategoriesController::class, 'action'=> 'show', 'method'=> 'GET']);
$router->add('category/{id:\d+}/edit', ['controller' => \App\controller\categories\CategoriesController::class, 'action'=> 'edit', 'method'=> 'GET']);
$router->add('category/{id:\d+}/update', ['controller' => \App\controller\categories\CategoriesController::class, 'action'=> 'update', 'method'=> 'POST']);
$router->add('category/{id:\d+}/delete', ['controller' => \App\controller\categories\CategoriesController::class, 'action'=> 'destroy', 'method'=> 'POST']);
